...
interface BottomSheetButtonProps extends PressableProps {
...
export const BottomSheetButton = (props: BottomSheetButtonProps) => {
    ...
    return (
        <Pressable onPress={props.onPress} className={`rounded-md px-3 flex-row items-center justify-between my-2`} style={{ opacity: props.disabled ? 0.3 : 1 }}>
